...
export function middleware(request: NextRequest) {
  ...
  const isPublicPath = path === '/participants/signup' || path === '/participants/signin' || path === '/researchers/signup' || path === '/researchers/signin' || path === '/signup' || path === '/verifyemail' || path === '/'
