          ...
          <div className="bg-white grid md:grid-cols-2 lg:gap-24 gap-16 w-full sm:p-8 p-6 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded overflow-hidden">
            ...
            <form className="w-full">
              ...
              <div className="!mt-10">
                <button
                  type="button"
                  className="w-full py-3 px-4 text-sm font-semibold rounded bg-[#1553A4] hover:bg-blue-100 border hover:border-[#1553A4] text-white hover:text-[#1553A4] focus:outline-none"
                >
                  Create Account
                </button>
              </div>
