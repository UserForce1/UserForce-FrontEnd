...
import signUpFormSchema from "@/app/schema/participants/signUpFormSchema";
import useForm from "@/app/hooks/useForm";
import SignUpForm from "@/app/components/forms/participants/SignupForm";
  ...
  return (
    <>
      <div className="font-[sans-serif] text-[#333] bg-white min-h-screen  items-center justify-center ">
        ...
        <div className="sm:w-1/2 max-w-4xl items-center justify-center mx-auto mt-20 px-6">
          <div className=" mx-auto bg-white shadow-[0_2px_18px_-3px_rgba(6,81,237,0.4)] sm:p-8 p-4 rounded-md">
          ...
          <div className="fixed inset-0 px-4 flex flex-wrap justify-center items-center w-full h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto font-[sans-serif]">
            <div className="w-full max-w-md bg-white shadow-lg rounded-md px-5 py-10 relative mx-auto text-center">
              ...
              <div className="mt-8">
                ...
                Please check your email inbox / spam for details and verify your email to begin with userforce
                </p>
                <button
                  type="button"
                  onClick={() => {
