    ...
    <header className="flex shadow-md py-4 px-4 sm:px-10 bg-white font-[Poppins] min-h-[70px] tracking-wide relative z-50 border-[#D9DEDD]">
      <div className="flex flex-wrap items-center justify-between gap-5 w-full">
        ...
        <div className="flex ml-auto">
          {data && <>
            <div className="shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] text-black flex items-center border-t-4 border-blue-500  px-4 py-4 rounded font-[sans-serif]"
      role="alert">
      ...
      <span className="text-xs font-semibold ml-2">{data}</span>
    </div>
          </>}
          <button
            onClick={logout}
            className="bg-[#1553A4] hover:bg-blue-200 text-white hover:text-[#1553A4] hover:border-[#1553A4] border flex items-center font-semibold rounded-md px-4 py-4 transition-all"
          >
            Log out
            <svg
              xmlns="http://www.w3.org/2000/svg"
