...
import { PsignUpFormData } from "@/app/interfaces/FormData";

interface TheFormProps {
  formData: PsignUpFormData;
  ...
  return (
    <form className="w-full" onSubmit={handleSubmit}>
      ...
      <div className="space-y-6">
        <div>
          <label className="text-base leading-relaxed mb-2 block">Name</label>
          <Element name="fullName">
            <div className="relative flex items-center">
              <input
                type="text"
                className="bg-white border border-gray-300 w-full text-sm pl-4 pr-10 py-2.5 rounded outline-[#1553A4]"
        ...
        <div>
          <label className="text-base leading-relaxed mb-2 block">
            Email Id
          </label>
          <Element name="email">
            <div className="relative flex items-center">
