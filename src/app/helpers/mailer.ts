...
// Update the user document in the database with the generated token and expiry time
        ...
        // Compose email options
              const mailOptions = {
                ...
                html: `<p>Welcome! We're thrilled that you've joined our researcher community. Click <a href="${process.env.domain}/verifyemail?token=${hashedToken}=researchers">here</a> to 
